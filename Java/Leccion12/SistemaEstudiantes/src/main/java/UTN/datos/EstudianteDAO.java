...
public class EstudianteDAO {
    ...
    public static void main(String[] args) {
        ...
        var estudianteModificado = new Estudiante(1, "Juan Carlos", "Juerez","juan@mail.com" , "12345678");
        ...
        //Agregar estudiante
        var nuevoEstudiante = new Estudiante("Carlos", "Lara", "carlos@mail.com", "54922334455");
        var agregado = estudianteDao.agregarEstudiante(nuevoEstudiante);
        if (agregado)
            System.out.println("Estudiante agregado: "+ nuevoEstudiante);
        else
