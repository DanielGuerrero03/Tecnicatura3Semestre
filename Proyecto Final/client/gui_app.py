...
class Frame (tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        #Boton guardar
        self.boton_guardar = tk.Button(self, text = 'Guardar', comman = self.guardar_datos)
    ...
    def tabla_peliculas(self):
        ...
        #Recuperar la lista de peliculas de la bd
        self.lista_peliculas = listar() 
        self.lista_peliculas.reverse()      
        
        self.tabla = ttk.Treeview(self, colum = ('Nombre', 'Duracion', 'Género'))
